...
! function(t) {
    ...
    function d() {
        v.html(Q), h.find(">:first-child").addClass("figlio"), t(".figlio").css("width", k).css("height", C).css("padding", m).css("background", c), G = h.outerHeight(), F = t(window).height(), F > G + 80 ? (z = (F - G) / 2, h.css("margin-top", z), h.css("margin-bottom", z)) : (h.css("margin-top", "80px"), h.css("margin-bottom", "60px")), h.animate({
            opacity: "1"
        }, "slow")
    }

    function l() {
        t(".vbox-content").length && (G = h.height(), F = t(window).height(), F > G + 80 ? (z = (F - G) / 2, h.css("margin-top", z), h.css("margin-bottom", z)) : (h.css("margin-top", "80px"), h.css("margin-bottom", "60px")))
    }
