...
! function(t) {
    ...
    x.ui = x.ui || {}, x.ui.version = "1.13.0",
        ...
        W = Math.max, C = Math.abs, o = /left|center|right/, s = /top|center|bottom/, r = /[\+\-]\d+(\.[\d]+)?%?/, l = /^\w+/, a = /%$/, h = x.fn.position, x.position = {
            ...
            var c, d, p, g, m, t, v = "string" == typeof(u = x.extend({}, u)).of ? x(document).find(u.of) : x(u.of),
            ...
            return v[0].preventDefault && (u.at = "left top"), d = e.width, p = e.height, m = x.extend({}, g = e.offset), x.each(["my", "at"], function() {
                var t, e, i = (u[this] || "").split(" ");
                (i = 1 === i.length ? o.test(i[0]) ? i.concat(["center"]) : s.test(i[0]) ? ["center"].concat(i) : ["center", "center"] : i)[0] = o.test(i[0]) ? i[0] : "center", i[1] = s.test(i[1]) ? i[1] : "center", t = r.exec(i[0]), e = r.exec(i[1]), _[this] = [t ? t[0] : 0, e ? e[0] : 0], u[this] = [l.exec(i[0])[0], l.exec(i[1])[0]]
            }), 1 === b.length && (b[1] = b[0]), "right" === u.at[0] ? m.left += d : "center" === u.at[0] && (m.left += d / 2), "bottom" === u.at[1] ? m.top += p : "center" === u.at[1] && (m.top += p / 2), c = E(_.at, d, p), m.left += c[0], m.top += c[1], this.each(function() {
                var i, t, r = x(this),
                    l = r.outerWidth(),
                    a = r.outerHeight(),
                    e = L(this, "marginLeft"),
                ...
                "right" === u.my[0] ? h.left -= l : "center" === u.my[0] && (h.left -= l / 2), "bottom" === u.my[1] ? h.top -= a : "center" === u.my[1] && (h.top -= a / 2), h.left += f[0], h.top += f[1], i = {
                    marginLeft: e,
                    marginTop: n
                    ...
                    d < l && C(e + i) < d && (s.horizontal = "center"), p < a && C(n + o) < p && (s.vertical = "middle"), W(C(e), C(i)) > W(C(n), C(o)) ? s.important = "horizontal" : s.important = "vertical", u.using.call(this, t, s)
                }), r.offset(x.extend(h, {
                    using: t
                }))
            })
    ...
    x.cleanData = (u = x.cleanData, function(t) {
        ...
        _classes: function(o) {
            ...
            function t(t, e) {
                for (var i, n = 0; n < t.length; n++) i = r.classesElementLookup[t[n]] || x(), i = o.add ? (o.element.each(function(t, e) {
